...
function Goods() {
  return (
    <section className="goods container">
      <ul className="goods__container" data-aos="slide-up" data-aos-duration="1000">
        ...
        <li className="goods__item" data-aos="slide-up" data-aos-duration="1000">
        ...
        <li className="goods__item goods__item_type_active" data-aos="slide-up" data-aos-duration="1500">
